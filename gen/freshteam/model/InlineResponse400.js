...
var _Model400Error = _interopRequireDefault(require("./Model400Error"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errors')) {
          obj['errors'] = _ApiClient["default"].convertToType(data['errors'], [_Model400Error["default"]]);
        }
      }
...
/**
 * @member {Array.<module:model/Model400Error>} errors
 */

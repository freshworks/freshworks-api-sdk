...
* @version 1.0.0
*/
var SourceCategoriesApi = /*#__PURE__*/function () {
  /**
  ...
  */
  function SourceCategoriesApi(apiClient) {
    _classCallCheck(this, SourceCategoriesApi);
  ...
  _createClass(SourceCategoriesApi, [{
    key: "getSourceCategoriesWithHttpInfo",
    value: function getSourceCategoriesWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      var returnType = [_SourceCategory["default"]];
      return this.apiClient.callApi('/candidate_source_categories', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * List of source categories
     * List of source categories
    ...
    key: "getSourceCategories",
    value: function getSourceCategories() {
  ...
  return SourceCategoriesApi;
}();

exports["default"] = SourceCategoriesApi;
...
function listEmployees() {
  client.request.invoke("listEmployees", {}).then(
    function (data) {
      console.log("success");
      console.log(data);
    },
...
function getEmployee(employee) {
  client.request.invoke("getEmployee", { id: employee.id }).then(
    function (data) {
      console.log(data);
    },
    function (error) {
...
function createEmployee(employeeProperties) {
  client.request.invoke("createEmployee", employeeProperties).then(
    function (data) {
      console.log(data);
    },
    function (error) {
...
function updateEmployee(employeeProperties) {
  client.request.invoke("updateEmployee", { properties: employeeProperties }).then(
    function (data) {
      console.log(data);
    },
    function (error) {
...
function listEmployeeFields() {
  client.request.invoke("listEmployeeFields", {}).then(
    function (data) {
      console.log(data);
    },
    function (error) {
...
function createEmployeeField(employeeFieldProperties) {
  client.request.invoke("createEmployeeField", employeeFieldProperties).then(
    function (data) {
      console.log(data);
    },
    function (error) {
